...
import QuillEdit from "./QuillEditAdmin";
import ActivityEdit from "./ActivityEditAdmin";
...
export default function EditCurseAdmin({
  selections,
  courseInfo,
  setCourseInfo,
  position,
  ...
  const addDataCurse = () => {
    const elementWithPosition = courseInfo.data.find(
...
EditCurseAdmin.propTypes = {
  ...
  selectedQuestion: PropTypes.any.isRequired,
  setSelectedQuestion: PropTypes.func.isRequired,
  text: PropTypes.any.isRequired,
  setText: PropTypes.func.isRequired,
  setIdCurse: PropTypes.func.isRequired,
};
